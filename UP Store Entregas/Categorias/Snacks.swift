...
//  UP Store Entregas
//
//  Created by Emanuel Morales on 015/12/22.
//  Copyright © 2020 ASNK. All rights reserved.
//

import UIKit
import CoreData
class Snacks: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchResultsUpdating {
//Variables
    var lista = [Lista]()
...
// Base de datos
        if let filePath = Bundle.main.path(forResource: "Snacks", ofType: "txt"){
            do{
