...
import UIKit
import CoreData
class BebidasAlcoholicas: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchResultsUpdating {
//Variables
    var lista = [Lista]()
...
// Base de datos
        if let filePath = Bundle.main.path(forResource: "BebidasAlcoholicas", ofType: "txt"){
            do{
