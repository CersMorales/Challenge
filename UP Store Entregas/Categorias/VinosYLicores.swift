...
import UIKit
import CoreData
class VinosYLicores: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchResultsUpdating {
//Variables
    var lista = [Lista]()
...
// Base de datos
        if let filePath = Bundle.main.path(forResource: "VinosyLicores", ofType: "txt"){
            do{
