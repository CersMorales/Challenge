...
import UIKit
import CoreData
class Bakery: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchResultsUpdating {
//Variables
    var lista = [Lista]()
...
// Base de datos
        if let filePath = Bundle.main.path(forResource: "Bakery", ofType: "txt"){
            do{
