...
import UIKit
import CoreData
class Bebidas: UIViewController, UITableViewDataSource, UITableViewDelegate,UISearchResultsUpdating {
//Variables
    var lista = [Lista]()
...
// Base de datos
        if let filePath = Bundle.main.path(forResource: "Bebidas", ofType: "txt"){
            do{
